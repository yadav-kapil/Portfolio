...
const Projects = () => {
  ...
  const notify = () => toast.error("Currently Live Demo Not Available");
    ...
    <>
          ...
          >
            ...
            <div className="relative p-6">
              ...
              <p className="mt-3 text-sm leading-relaxed font-inter text-gray-600 dark:text-gray-300">
                Learnify is an AI-powered assistant that helps users solve
                doubts, practice concepts, and learn interactively.
              </p>
      ...
      "
              ...
              <div className="mt-6 flex gap-4">
                <a
                  href="https://github.com/yadav-kapil/Learnify_Hacksprint"
                  target="_blank"
                  className="
                  flex-1 text-center
