...
return (
  ...
  const dotColor = useTransform(
    scrollYProgress,
    [progressPoint - 0.30, progressPoint-0.10],
  ...
  return (
    ...
    >
      <div className="sticky flex flex-col md:flex-row z-40 items-center 
                      top-40 self-start max-w-xs lg:max-w-sm md:w-full">

        {/* Animated Timeline Dot */}
        <div className="h-12 absolute left-2 md:left-2 w-12 
        ...
        <h3 className="hidden md:block text-3xl md:pl-24 md:text-6xl 
      ...
      <div className="relative pl-20 pr-6 md:pl-6 w-full">
        <h3 className="md:hidden block text-2xl mb-6 text-left 
